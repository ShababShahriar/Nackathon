...
//            problemType.setText(Utility.HazardTags.getHazardTags()[currentPost.getCategory()]);
    ...
    public void popularOfferList() {
        ...
        offerItemArrayList.add(new OfferListItem("Sundarban Tourism", "3 Days 4 Nights package tour for two persons. Only in 6000taka", "31 Dec, 2016", "0171..."));
        offerItemArrayList.add(new OfferListItem("Rajshahi Tourism Company", "Find beautiful Rajshahi, 36 hours from dhaka tour only 2000 taka", "29 Feb, 1997", "0181..."));
        offerItemArrayList.add(new OfferListItem("Bandarban Travels", "3 Days tour, Nilgiri and Nilachal staying at night. Only 4000 taka.", "31 Dec, 2016", "0171..."));
